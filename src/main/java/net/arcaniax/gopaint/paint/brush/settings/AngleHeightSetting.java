...
public class AngleHeightSetting extends AbstractSetting {
    ...
    public void increase(PlayerBrush playerBrush, boolean isShifting) {
        ...
        if (playerBrush.getMinHeightDifference() > GoPaint.getSettings().getMaxAngleHeightDifference()) {
            playerBrush.setMinHeightDifference(GoPaint.getSettings().getMaxAngleHeightDifference());
        }
    ...
    public void decrease(PlayerBrush playerBrush, boolean isShifting) {
        ...
        if (playerBrush.getMinHeightDifference() < GoPaint.getSettings().getMinAngleHeightDifference()) {
            playerBrush.setMinHeightDifference(GoPaint.getSettings().getMinAngleHeightDifference());
        }
        playerBrush.updateInventory();
    }
